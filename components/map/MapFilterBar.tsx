        ...
        <div className="fixed bottom-0 left-0 right-0 sm:bottom-6 sm:right-6 sm:left-auto z-50 flex flex-col items-end px-4 sm:px-0">
            ...
            <div className="flex items-center space-x-3 mb-4 w-full sm:w-auto justify-center sm:justify-end">
                ...
                <button
                    ...
                    className="w-11 h-11 bg-[#FFD700] rounded-full flex items-center justify-center shadow-xl border-2 border-white hover:scale-105 active:scale-95 transition-all"
                ...
                {/* Zoom Capsule */}
                <div className="bg-white rounded-full h-11 flex items-center shadow-xl px-1 border border-gray-100">
                    <button
                        onClick={onZoomOut}
            ...
            <div className={`bg-white rounded-t-[20px] sm:rounded-[16px] shadow-2xl overflow-hidden transition-all duration-300 w-full sm:w-[340px]`}>
                {/* Header */}
                <div
                ...
                >
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 text-sm font-lexend">Map Filters</h3>
                    ...
                    <div className="px-6 pb-6 pt-2 animate-in fade-in slide-in-from-top-2 duration-300">
                        ...
                        <div className="flex bg-gray-100 p-1 rounded-xl mb-6">
                            <button
                                ...
                                className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition-all ${activeTab === 'filters' ? 'bg-white shadow-sm text-[#ED6D28]' : 'text-gray-500 hover:text-gray-700'}`}
                            >
                                Search Pins
                            </button>
                            <button
                                onClick={() => setActiveTab('community')}
                                className={`flex-1 py-1.5 rounded-lg text-xs font-bold transition-all ${activeTab === 'community' ? 'bg-white shadow-sm text-[#ED6D28]' : 'text-gray-500 hover:text-gray-700'}`}
                            >
                                Community
                            </button>
                        </div>
                        ...
                        {activeTab === 'filters' ? (
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#F3F4F6] border-none rounded-xl pl-10 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-[#ED6D28]/20 transition-all font-medium text-gray-700 placeholder:text-gray-400"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative mb-2">
                                        <select
                                            ...
                                            className="w-full bg-[#F3F4F6] border-none rounded-xl px-4 py-2 text-[11px] font-bold text-gray-600 focus:ring-2 focus:ring-[#ED6D28]/20 transition-all appearance-none cursor-pointer"
                                            defaultValue=""
                                        >
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <div className="relative flex-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-[#F3F4F6] border-none rounded-xl pl-10 pr-2 py-2 text-[11px] focus:ring-2 focus:ring-[#ED6D28]/20 transition-all font-medium text-gray-700"
                                            />
                                        </div>
                                        <div className="relative flex-1">
                                            <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                            ...
                            <div className="space-y-4">
                                <div
                                    ...
                                    className="p-4 bg-orange-50/50 border border-orange-100 rounded-2xl cursor-pointer hover:bg-orange-50 transition-all group"
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <h4 className="font-bold text-gray-900 mt-1">{selectedCommunityName}</h4>
                                            </div>
                                        </div>
