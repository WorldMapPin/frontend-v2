...
const ShowcaseCard = ({ gradient, bgColor, borderColor, title, description, image }: ShowcaseCardProps) => (
  <div
    className="rounded-lg shadow-lg overflow-hidden border-2 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl group showcase-card"
    style={{ borderColor }}
  >
    <div
    ...
    <div className="p-6" style={{ backgroundColor: 'var(--card-bg)' }}>
      ...
      <p className="font-lexend font-medium text-base" style={{ color: 'var(--text-secondary)' }}>
        {description}
      </p>
    </div>
  </div>
