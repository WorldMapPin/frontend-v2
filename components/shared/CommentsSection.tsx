...
function CommentItem({
  ...
  const handleLoadReplies = async () => {
    ...
    try {
      const fetchedReplies = await onLoadReplies(
        comment.author,
        comment.permlink,
      );
    ...
    <div className="comment-item">
      ...
      <div className="flex items-start gap-2 sm:gap-3">
        ...
        <Link href={`/@${comment.author}`} className="flex-shrink-0">
          <img
            src={`https://images.ecency.com/u/${comment.author}/avatar/small`}
                  ...
                  >
                    {loadingReplies ? (
                      ...
                      <>
                        ...
                        <span>
                          {showReplies ? "Hide" : ""} {comment.children}{" "}
                ...
                <div className="mt-2 sm:mt-3 p-2 sm:p-3 rounded-lg comment-reply-input-container">
                  {replySuccess ? (
                    <div className="flex items-center gap-1.5 sm:gap-2 text-green-600">
                      ...
                      <span className="text-xs sm:text-sm font-medium font-lexend">
                        Posted!
                      </span>
                    </div>
                  ) : (
                    <div className="space-y-1.5 sm:space-y-2">
                      ...
                      />
                      {replyError && (
                        <p className="text-[10px] sm:text-xs text-red-500 truncate font-lexend">
                          {replyError}
                        </p>
                      )}
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-[10px] sm:text-xs text-gray-400 truncate font-lexend">
                          as @{user}
                        </span>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <p
                className="text-xs sm:text-sm font-medium truncate font-lexend"
                style={{ color: "var(--text-secondary)" }}
              >
                Log in to join the conversation
              </p>
              <p
                className="text-[10px] sm:text-xs hidden sm:block font-lexend"
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-4 sm:mb-6">
      <div className="flex gap-2 sm:gap-3">
        {/* User Avatar */}
        <img
          src={`https://images.ecency.com/u/${user}/avatar/small`}
          alt={`${user}'s avatar`}
        ...
        <div className="flex-1 space-y-2 sm:space-y-3">
          {success ? (
            ...
            <>
              ...
              <div className="flex items-center justify-between gap-2">
                <span
                  className="text-[10px] sm:text-xs truncate font-lexend"
                  style={{ color: "var(--text-muted)" }}
                >
                  as @{user}
                </span>
