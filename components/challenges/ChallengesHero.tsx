...
import { Snowflake, Gift, Ticket, Trophy } from 'lucide-react';
...
export default function ChallengesHero({
    ...
    return (
        <div className="mx-auto px-2 sm:px-4 lg:px-8 pt-2 sm:pt-4" style={{ maxWidth: '1344px' }}>
            ...
            {/* Hero 1: Challenges Title Banner */}
            <div
                className="rounded-lg sm:rounded-xl shadow-lg m-2 sm:m-4 relative overflow-hidden"
            ...
            >
                ...
                <div className="relative px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8 z-10 pl-12 sm:pl-20 lg:pl-16">
                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white" style={{ fontFamily: 'var(--font-lexend)' }}>
                        Challenges
                    </h1>
                    <p className="text-white mt-1 sm:mt-2 text-xs sm:text-sm lg:text-base opacity-90" style={{ fontFamily: 'var(--font-lexend)' }}>
                        Compete with the WorldMapPin community and win exciting prizes
                    </p>
                </div>
            </div>

            {/* Hero 2: Current Challenge - Winter Challenge */}
