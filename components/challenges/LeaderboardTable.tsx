  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <div
          className="h-4 w-24 sm:w-32 rounded"
          style={{ backgroundColor: "var(--skeleton-bg)" }}
        />
      </div>
      <div
        className="h-6 w-16 sm:w-20 rounded"
        style={{ backgroundColor: "var(--skeleton-bg)" }}
      />
    </div>
  );
...
export default function LeaderboardTable({
  ...
  if (loading) {
    return (
      <div
        className="mx-auto px-2 sm:px-4 lg:px-8 pb-8"
        style={{ maxWidth: "1344px" }}
      >
        <div className="m-2 sm:m-4">
          {/* Search skeleton */}
          <div
            className="mb-4 h-12 rounded-xl animate-pulse"
            style={{ backgroundColor: "var(--skeleton-bg)" }}
          />
        ...
        <div className="space-y-2">
          {filteredData.map((item) => (
            ...
            >
              ...
              {/* Avatar */}
              <img
                src={`https://images.ecency.com/u/${item.username}/avatar`}
