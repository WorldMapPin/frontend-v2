...
export default function AboutPage() {
  ...
  About
        ...
        <h1 className="font-lexend text-3xl sm:text-4xl md:text-5xl font-semibold text-[#FFFFFF] mb-4 sm:mb-6">
          ...
          Through <span className="about-header-blockchain">Blockchain</span>
        </h1>
      ...
      {/* Our Story Section */}
      <div className="bg-[linear-gradient(92.88deg,_#FFE1D1_1.84%,_#F7DCAA_100%)] about-section-dark rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 mb-4 sm:mb-6 md:mb-8 min-h-[400px] sm:min-h-[500px] md:min-h-[610px] border-[2px] border-[#5E210040] flex items-center">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center justify-items-center w-full">
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6"><span className="text-[#592102]">Our</span> <span className="about-highlight-word">Story</span></h2>
      ...
      <div className="bg-[linear-gradient(119.72deg,_#FFDBC7_31.83%,_#FFEAC7_89.02%)] about-section-dark rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 mb-4 sm:mb-6 md:mb-8 min-h-[400px] sm:min-h-[500px] md:min-h-[610px] border-[2px] border-[#5E210040] flex items-center">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center justify-items-center w-full">
          ...
          <div className="order-1 md:order-2 text-center md:text-right flex flex-col justify-center">
            <p className="font-lexend text-[#592102] text-xl md:text-lg mb-4">About</p>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6"><span className="text-[#592102]">People</span> <span className="about-highlight-word">Centric</span></h2>
      ...
      <div className="bg-[linear-gradient(161.38deg,_#FFF8E0_12.6%,_#FFE6B8_87.4%)] about-section-dark rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 mb-4 sm:mb-6 md:mb-8 min-h-[400px] sm:min-h-[500px] md:min-h-[610px] border-[2px] border-[#5E210040] flex items-center">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center justify-items-center w-full">
          <div className="flex flex-col justify-center">
            <p className="font-lexend text-[#592102] text-xl md:text-lg mb-4">About</p>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
              Built on <span className="text-[#592102] about-highlight-word">Hive</span>
            </h2>
            <p className="font-lexend text-lg sm:text-xl md:text-[28px] leading-[125%] tracking-[-0.03em] text-[#331B00] max-w-xs sm:max-w-xl md:max-w-none">
