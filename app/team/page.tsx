  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        {/* Hero Section */}
        <div
          className="rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden mb-12 relative"
          style={{
            background:
        ...
        >
          ...
          <div className="relative z-10 px-6 sm:px-12 py-10 sm:py-16 text-center">
            <p className="font-lexend text-white text-sm sm:text-base font-bold mb-3 uppercase tracking-wider opacity-90">
              Our Team
            </p>
            ...
            <p className="font-lexend text-base sm:text-lg md:text-xl max-w-2xl mx-auto text-white/90 font-medium leading-relaxed">
              A diverse community of innovators, creators, and problem-solvers
              working together to build amazing experiences.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="text-center mb-8">
            <h2
              className="font-lexend text-2xl sm:text-3xl font-bold mb-4"
          ...
          {/* Team Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-5 w-full">
