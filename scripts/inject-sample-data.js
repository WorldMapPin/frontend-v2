  ...
  mappedStores: [
    {
      ...
      profile: {
        ...
        displayImage:
          "https://images.ecency.com/600x0/https://images.ecency.com/DQmRRWwaQtb8Xdr6XYeX1hmm5LrGHWJ5yY5ZQUyrnhRV6of/sample-store-1.jpg",
    ...
    },
    {
      ...
      profile: {
        ...
        displayImage:
          "https://images.ecency.com/600x0/https://images.ecency.com/DQmRRWwaQtb8Xdr6XYeX1hmm5LrGHWJ5yY5ZQUyrnhRV6of/sample-store-2.jpg",
    ...
    "sample-store-1": [
      {
        ...
        photos: [
          "https://images.ecency.com/600x0/https://images.ecency.com/sample-food-photo.jpg",
        ],
        reviewText: "Amazing food and great service!",
        reviewBody:
          "I had an excellent experience at this restaurant. The food was delicious and the staff was very friendly. Highly recommended!",
      ...
      },
      {
        ...
        reviewBody:
          "The ambiance was great and the food was outstanding. Will definitely come back again.",
    ...
    "sample-store-2": [
      {
        ...
        photos: [
          "https://images.ecency.com/600x0/https://images.ecency.com/sample-product-photo.jpg",
        ],
        reviewText: "Found exactly what I needed!",
        reviewBody:
          "Great selection of products and helpful staff. The quality is excellent.",
...
// Combine all stores
sampleData.allStores = [
  ...sampleData.mappedStores,
  ...sampleData.unmappedStores,
];
...
console.log(
  `   - ${Object.keys(sampleData.storeReviews).length} stores with reviews`,
);
